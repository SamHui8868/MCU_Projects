...
# 78 "mcc_generated_files/eusart2.h"
...
# 57 "main.c"
volatile uint16_t Modbus_Holding_Register[66];
...
unsigned short u32_sqrt(uint32_t a)
{
unsigned long rem = 0;
...
void check_register()
{
if(Modbus_Holding_Register[64])
{
if(Modbus_Holding_Register[65])
{
string_tx_uart2("jumping,relay can't open\n");
Modbus_Holding_Register[64]=0;
LATAbits.LATA1=1;
}
else
{
...
{
timer=0;
Modbus_Holding_Register[61]=u32_sqrt(Vrms/adc_count);
sample_total=Modbus_Holding_Register[61];
if(Modbus_Holding_Register[61]>Modbus_Holding_Register[62])
{
Modbus_Holding_Register[64]=0;
Modbus_Holding_Register[65]=1;
...
if(Modbus_Holding_Register[63])
{
sample_count++;
if(sample_count>=Modbus_Holding_Register[63])
{
Modbus_Holding_Register[Modbus_Holding_Register[60]%60]=sample_total/sample_count;
Modbus_Holding_Register[60]=(Modbus_Holding_Register[60]==59999)?0:Modbus_Holding_Register[60]+1;
sample_count=0;
}
}
else
...
uint8_t i;
for(i=0;i<60;i++)
Modbus_Holding_Register[i]=0;
timer=0;
Modbus_Holding_Register[60]=0;
Modbus_Holding_Register[61]=0;
Modbus_Holding_Register[62]=300;
Modbus_Holding_Register[63]=1;
Modbus_Holding_Register[64]=1;
Modbus_Holding_Register[65]=0;
